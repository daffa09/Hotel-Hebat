...
<div class="container-fluid bg-light" style="border-radius: 10px">
    ...
    <div class="d-flex justify-content-center">
        ...
        {{-- NOTE --}}
        {{-- Unutk mengirim data menggunakan post jgn gunakan 'disable' pada form yang tidak ingin di rubah --}}
        ...
        <form class="d-flex justify-content-center" action="{{ url('/pemesanan/reservasi') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group m-3">
                ...
                <input type="date" class="form-control" id="tgl_checkin" name="tgl_checkin" value="{{ $tgl_checkin }}" readonly>
            </div>

            <div class="form-group m-3">
                <label for="tgl_checkout">Tanggal Checkout</label>
                <input type="date" class="form-control" id="tgl_checkout" name="tgl_checkout" value="{{ $tgl_checkout }}" readonly>
            </div>
            ...
            <div class="form-group m-3" style="margin: 32px">
                ...
                <input type="number" class="form-control" id="jml_kamar" name="jml_kamar" value="{{ $jml_kamar }}" readonly="readonly">
            </div>
    </div>
